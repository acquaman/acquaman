...
#ifndef AMAXISFINISHEDACTION_H
#define AMAXISFINISHEDACTION_H

#include "actions3/AMAction3.h"
#include "actions3/actions/AMAxisFinishedActionInfo.h"

class AMAxisFinishedAction : public AMAction3
{
Q_OBJECT
public:
	/// Constructor
	...
	virtual AMAction3* createCopy() const { return new AMAxisFinishedAction(*this); }
...
protected:
	...
	const AMAxisFinishedActionInfo* axisFinishedInfo() const { return qobject_cast<const AMAxisFinishedActionInfo*>(info()); }
	/// We can always access our info object via info_ or info(), but it will come back as a AMActionInfo* pointer that we would need to cast to AMAxisStartedActionInfo. This makes it easier to access.
	AMAxisFinishedActionInfo* axisFinishedInfo() { return qobject_cast<AMAxisFinishedActionInfo*>(info()); }
};

#endif // AMAXISFINISHEDACTION_H
