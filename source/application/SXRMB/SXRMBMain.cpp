...
#include "application/SXRMB/SXRMBAppController.h"
...
int main(int argc, char *argv[])
{
	...
	SXRMBAppController* appController = new SXRMBAppController();
	...
	AMCrashMonitorSupport::s()->setPathToCrashReportFiles("/home/acquaman/AcquamanApplicationCrashReports/SXRMB");
