...
bool VESPERSAppController::startup() {
	...
	if(AMAppController::startup()) {
		...
		VESPERSBeamlineView *vespersView = new VESPERSBeamlineView;
		//VESPERSDeviceStatusView *statusPage = new VESPERSDeviceStatusView;

		mw_->insertHeading("Beamline Control", 0);
		mw_->addPane(vespersView, "Beamline Control", "Endstation", ":/system-software-update.png");
		...
		mw_->setCurrentPane(vespersView);
