...
#ifndef BAREBONESAPPCONTROLLER_H
#define BAREBONESAPPCONTROLLER_H

#include "application/AMAppController.h"

class BareBonesAppController : public AMAppController {
	Q_OBJECT
...
public:
	...
	explicit BareBonesAppController(QObject* parent = 0);
...
#endif // BAREBONESAPPCONTROLLER_H
