...
#include "BXSAppController.h"


BXSAppController::BXSAppController(QObject *parent) :
...
//bool BXSAppController::startupBeforeAnything() {
...
//bool BXSAppController::startupCreateUserInterface() {
...
//void BXSAppController::shutdown() {
