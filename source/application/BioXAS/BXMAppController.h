...
#ifndef BXMAPPCONTROLLER_H
#define BXMAPPCONTROLLER_H

#include "application/AMAppController.h"

class BXMAppController : public AMAppController {
	Q_OBJECT
...
public:
	...
	explicit BXMAppController(QObject* parent = 0);

	/// Destructor
	virtual ~BXMAppController() {}
