...
protected:
	...
	class pvPrivate {
		...
		typedef std::map<std::string,std::string> pvproperties_t;
		typedef pvproperties_t::iterator pvproperties_iter;
		pvproperties_t pvproperties;
	...
	typedef map<int, pvPrivate*> pvInfo_t;
	typedef pvInfo_t::iterator pvInfo_iter;
	pvInfo_t pvInfo;
