...
enum acqControlIndex {	CONTROL_PV, HAVE_START, HAVE_DELTA, HAVE_FINAL,
...
void acqModifyScanControlEntry( acqScan_t *scanp, int index, ...);
void acqAddScanControlEntry(acqMaster_t *master, acqScan_t *scanp, int index, ...);
...
void acq_file_load_append( const char *fname, acqMaster_t *master);
void acq_clear( acqMaster_t *master);
