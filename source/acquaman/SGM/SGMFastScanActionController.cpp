...
void SGMFastScanActionController::onFileWriterError(AMScanActionControllerBasicFileWriter::FileWriterError error){
	...
	case AMScanActionControllerBasicFileWriter::FailedToWriteFile:
		AMErrorMon::alert(this, SGMFASTSCANACTIONCONTROLLER_FAILED_TO_WRITE_FILE, QString("Error, SGM Fast Scan Action Controller failed to write your data. This is a serious problem, please contact the Acquaman developers."));
