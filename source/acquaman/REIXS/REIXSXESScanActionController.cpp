...
void REIXSXESScanActionController::onFileWriterError(AMScanActionControllerBasicFileWriter::FileWriterError error)
{
	...
	case AMScanActionControllerBasicFileWriter::FailedToWriteFile:
		AMErrorMon::alert(this, REIXSXESSCANACTIONCONTROLLER_FAILED_TO_WRITE_FILE, QString("Error, the %1 Scan Action Controller failed to write your data. This is a serious problem, please contact the Acquaman developers.").arg(configuration_->technique()));
