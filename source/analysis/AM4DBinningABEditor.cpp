...
#include "AM4DBinningABEditor.h"

#include "analysis/AM4DBinningAB.h"
...
void AM4DBinningABEditor::onNameChoiceChanged(int index)
{
...
void AM4DBinningABEditor::onSumAxisControlChanged(int newSumAxis)
{
...
void AM4DBinningABEditor::onRangeMinControlChanged(int newRangeMin)
{
...
void AM4DBinningABEditor::onRangeMaxControlChanged(int newRangeMax)
{
