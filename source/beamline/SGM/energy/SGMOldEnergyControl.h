#ifndef SGMOLDENERGYCONTROL_H
#define SGMOLDENERGYCONTROL_H
 ...
 */
class SGMOldEnergyControl : public AMPseudoMotorControl
{
    Q_OBJECT
public:
    /*!
     ...
     * with.
     */
    SGMOldEnergyControl(SGMUndulatorSupport::UndulatorHarmonic undulatorHarmonic,
                     QObject* parent = 0);
