...
#include <QDebug>
SGMOldEnergyControl::SGMOldEnergyControl(SGMUndulatorSupport::UndulatorHarmonic undulatorHarmonic,
                                   QObject *parent) :
...
SGMUndulatorSupport::UndulatorHarmonic SGMOldEnergyControl::undulatorHarmonic() const
{
...
bool SGMOldEnergyControl::shouldMeasure() const
{
	return true;
}

bool SGMOldEnergyControl::shouldMove() const
{
	return true;
}

bool SGMOldEnergyControl::shouldStop() const
{
	return true;
}

bool SGMOldEnergyControl::canMeasure() const
{
	return shouldMeasure() && isConnected();
}

bool SGMOldEnergyControl::canMove() const
{
	return shouldMove() && isConnected();
}

bool SGMOldEnergyControl::canStop() const
{
	return shouldStop() && isConnected();
}


double SGMOldEnergyControl::undulatorOffset() const
{
    if(energyPositionController_) {
...
bool SGMOldEnergyControl::isUndulatorTracking() const
{
    if(energyPositionController_) {
...
SGMEnergyPosition::GratingTranslationOptimizationMode SGMOldEnergyControl::gratingTranslationOptimizationMode() const
{
    if(energyPositionController_) {
...
bool SGMOldEnergyControl::isExitSlitPositionTracking() const
{
    if(energyPositionController_) {
...
double SGMOldEnergyControl::gratingAngle() const
{
	if(energyPositionController_) {
...
SGMGratingSupport::GratingTranslation SGMOldEnergyControl::gratingTranslation() const
{
...
double SGMOldEnergyControl::undulatorPosition() const
{
	if(energyPositionController_) {
...
double SGMOldEnergyControl::exitSlitPosition() const
{
	if(energyPositionController_) {
...
void SGMOldEnergyControl::setUndulatorHarmonic(SGMUndulatorSupport::UndulatorHarmonic undulatorHarmonic)
{
	if(energyPositionController_ &&
...
void SGMOldEnergyControl::setUndulatorOffset(double undulatorOffset)
{
	if(energyPositionController_ &&
...
void SGMOldEnergyControl::setUndulatorTracking(bool isTracking)
{
	if(energyPositionController_ &&
...
void SGMOldEnergyControl::setGratingTranslationOptimizationMode(SGMEnergyPosition::GratingTranslationOptimizationMode gratingTranslationOptimizationMode)
{
	if(energyPositionController_ &&
...
void SGMOldEnergyControl::setExitSlitPositionTracking(bool isTracking)
{
	if(energyPositionController_ &&
...
void SGMOldEnergyControl::updateConnected()
{
	bool isConnected =
...
void SGMOldEnergyControl::updateMoving()
{
...
void SGMOldEnergyControl::updateValue()
{
   // updating of value performed by listening to energyPositionController_
   // energyChanged() signal.
}

void SGMOldEnergyControl::onGratingTranslationPVValueChanged(double value)
{
    if(energyPositionController_) {
...
void SGMOldEnergyControl::onEnergyPositionControllerEnergyChanged(double value)
{
    setValue(value);
}

double SGMOldEnergyControl::gratingTranslationEnumToDouble(SGMGratingSupport::GratingTranslation gratingTranslationEnum)
{
...
SGMGratingSupport::GratingTranslation SGMOldEnergyControl::gratingTranslationDoubleToEnum(double gratingTranslationValue)
{
...
void SGMOldEnergyControl::initializeEnergyPositionController()
{
...
AMAction3 *SGMOldEnergyControl::createMoveAction(double setpoint)
{
