...
IDEASMonochromatorControl::IDEASMonochromatorControl(QObject *parent)
    : AMPVwStatusControl("Energy", "BL08B2-1:Energy:EV:fbk", "BL08B2-1:Energy:EV", "BL08B2-1:Energy:status", "BL08B2-1:Energy:stop", parent, 0.5, 2.0, new AMControlStatusCheckerDefault(1), 1, "Mono Energy")
{
