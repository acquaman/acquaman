#include "KetekDetailedDetectorView.h"

KetekDetailedDetectorView::KetekDetailedDetectorView(IDEASKETEKDetector *detector, QWidget *parent)
	: IDEASXRFDetailedDetectorViewWithSave(detector, parent)
{
	ketekDetector_ = detector;
}

KetekDetailedDetectorView::~KetekDetailedDetectorView()
{

}

void KetekDetailedDetectorView::buildDetectorView()
{
...
void KetekDetailedDetectorView::onPeakingTimeBoxChanged(const QString &arg1)
{
...
void KetekDetailedDetectorView::onPeakingTimeChanged()
{
