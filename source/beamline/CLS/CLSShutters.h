...
public:
	...
	virtual bool isSafeToOpenShutters() const { return true; }
...
protected:
	...
	AMAction3* createMoveChildToOpenAction(AMControl *child);
	/// Creates and returns a new action that wait the child control opened.
	AMAction3* createWaitChildMoveToOpenAction(AMControl *child);
	/// Creates and returns a new action that closes the child control.
	AMAction3* createMoveChildToClosedAction(AMControl *child);
	/// Creates and returns a new action that wait the child control closed.
	AMAction3* createWaitChildMoveToClosedAction(AMControl *child);

	/// Creates and returns a new action that checks that the child control is open, waiting the timeout amount.
	AMAction3* createCheckChildIsOpenAction(AMControl *child, double timeoutSec);
	/// Creates and returns a new action that checks that the child control is closed, waiting the timeout amount.
	AMAction3* createCheckChildIsClosedAction(AMControl *child, double timeoutSec);
