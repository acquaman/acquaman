#ifndef CLSSENSITIVITYSR570_H
#define CLSSENSITIVITYSR570_H

#include "beamline/AMCurrentAmplifier.h"

class AMControl;

class CLSSensitivitySR570 : public AMCurrentAmplifier
{
Q_OBJECT
public:
	/// Constructor takes a user name and a PV baseName (ie,, amp1608-1001)
	CLSSensitivitySR570(const QString &name, const QString &baseName, QObject *parent = 0);

	/// Destructor
	virtual ~CLSSensitivitySR570();
