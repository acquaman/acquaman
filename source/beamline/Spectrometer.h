...
public:
        AMHexapod(const QString& name, QObject* parent = 0) : AMControl(name, "", parent) {
                x_ = new AMPVControl("x", "HXPD1610-4-I20:X:sp", "HXPD1610-4-I20:X", "HXPD1610-4-I20:moving", 0.01, this);
		...
		children_ << x_;
                y_ = new AMReadOnlyPVControl("y", "HXPD1610-4-I20:Y:sp", "HXPD1610-4-I20:moving", this);
		children_ << y_;
                z_ = new AMReadOnlyPVControl("z", "HXPD1610-4-I20:Z:sp", "HXPD1610-4-I20:moving", this);
		children_ << z_;
	}
