...
AMProcessVariableSupport::AMProcessVariableSupport() : QObject() {
	...
	/*
	qDebug() << "Try this " << QString("EPICS_CA_MAX_ARRAY_BYTES=%1").arg(AMPROCESSVARIABLE_MAX_CA_ARRAY_BYTES);
	qDebug() << "And this " << QString("EPICS_CA_MAX_ARRAY_BYTES=%1").arg(AMPROCESSVARIABLE_MAX_CA_ARRAY_BYTES).toAscii();
	qDebug() << "Also this " << QString("EPICS_CA_MAX_ARRAY_BYTES=%1").arg(AMPROCESSVARIABLE_MAX_CA_ARRAY_BYTES).toAscii().data();
	*/
