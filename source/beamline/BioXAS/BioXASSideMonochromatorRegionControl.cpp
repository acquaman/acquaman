	...
	BioXASSSRLMonochromatorRegionControl(parent)
{
	...
	setSlitsStatus(new AMReadOnlyPVControl(QString("SlitsStatus"), QString("BL1607-5-I22:Mono:SlitsClosed"), this));
	setPaddleControl(new AMPVControl("Paddle", "SMTR1607-5-I22-11:mm:fbk", "SMTR1607-5-I22-11:mm", QString(), this));
	setPaddleStatus(new AMReadOnlyPVControl(QString("PaddleStatus"), QString("BL1607-5-I22:Mono:PaddleExtracted"), this));
	setKeyStatus(new AMReadOnlyPVControl(QString("KeyStatus"), QString("BL1607-5-I22:Mono:KeyStatus"), this));
	setBrakeStatus(new AMReadOnlyPVControl(QString("BrakeStatus"), QString("BL1607-5-I22:Mono:BrakeOff"), this));
