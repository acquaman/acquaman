...
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_MASK_LOWER_CLOSED_LIMIT CLSMAXvMotor::LimitCW
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_PADDLE_REMOVED_LIMIT CLSMAXvMotor::LimitCCW
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_BRAGG_CRYSTAL_CHANGE_POSITION_LIMIT CLSMAXvMotor::LimitCCW
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_BRAGG_REGION_A_LIMIT CLSMAXvMotor::LimitCW
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_BRAGG_REGION_B_LIMIT CLSMAXvMotor::LimitCCW
...
// Error codes
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_CLOSE_UPPER_SLIT_FAILED 1407706
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_CLOSE_LOWER_SLIT_FAILED 1407707
#define BIOXASSSRLMONOCHROMATORREGIONCONTROL_CLOSE_SLITS_FAILED 1407708
