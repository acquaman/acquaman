...
{
	energySetpointDetector_ = new AMBasicControlDetectorEmulator("EnergySetpoint", "EnergySetpoint", BioXASSideBeamline::bioXAS()->mono()->energyControl()->writePV(), 0, 0, 0, AMDetectorDefinitions::ImmediateRead, this);
	energySetpointDetector_->setHiddenFromUsers(false);
	energySetpointDetector_->setIsVisible(true);

	energyFeedbackDetector_ = new AMBasicControlDetectorEmulator("EnergyFeedback", "EnergyFeedback", BioXASSideBeamline::bioXAS()->mono()->energyControl()->readPV(), 0, 0, 0, AMDetectorDefinitions::ImmediateRead, this);
