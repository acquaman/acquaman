	...
	BioXASCarbonFilterFarm("MainCarbonFilterFarm", parent)
{
	...
	addDownstreamActuatorWindow(Window::Top, BIOXASMAINCARBONFILTERFARM_DOWNSTREAM_TOP, BIOXASMAINCARBONFILTERFARM_DOWNSTREAM_TOP_MIN, BIOXASMAINCARBONFILTERFARM_DOWNSTREAM_TOP_MAX, 700);
