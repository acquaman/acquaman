	...
	BioXASValvesSetControl("BioXASImagingValves", parent)
{
	...
	vvrImaging7_ = new CLSBiStateControl("VVR1607-5-I10-09", "VVR1607-5-I10-09", "VVR1607-5-I10-09:state", "VVR1607-5-I10-09:opr:open", "VVR1607-5-I10-09:opr:close", new AMControlStatusCheckerDefault(4), this);
	vvrImaging8_ = new CLSBiStateControl("VVR1607-5-I10-10", "VVR1607-5-I10-10", "VVR1607-5-I10-10:state", "VVR1607-5-I10-10:opr:open", "VVR1607-5-I10-10:opr:close", new AMControlStatusCheckerDefault(4), this);
