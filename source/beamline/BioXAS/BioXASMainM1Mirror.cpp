...
BioXASMainM1Mirror::BioXASMainM1Mirror(const QString &name, QObject *parent) :
	BioXASM1Mirror(name, parent)
{
	setUpstreamLength(-543.725);
	setDownstreamLength(543.725);

	setMaskUpperBlade(new CLSMAXvMotor(QString("SMTR1607-5-I21-08 UPPER SLIT"), QString("SMTR1607-5-I21-08"), QString("SMTR1607-5-I21-08 UPPER SLIT"), true, 0.1, 2.0, this, QString(":mm")));
