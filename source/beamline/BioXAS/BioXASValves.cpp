	...
	BioXASBeamlineComponent("BioXASValves", parent)
{
	...
	vvrMain4_ = new CLSBiStateControl("MainVVR4", "MainVVR4", "VVR1607-5-I21-05:state", "VVR1607-5-I21-05:opr:open", "VVR1607-5-I21-05:opr:close", new AMControlStatusCheckerDefault(4), this);
	vvrMain5_ = new CLSBiStateControl("MainVVR5", "MainVVR5", "VVR1607-5-I21-06:state", "VVR1607-5-I21-06:opr:open", "VVR1607-5-I21-06:opr:close", new AMControlStatusCheckerDefault(4), this);
	vvrMain6_ = new CLSBiStateControl("MainVVR6", "MainVVR6", "VVR1607-5-I21-07:state", "VVR1607-5-I21-07:opr:open", "VVR1607-5-I21-07:opr:close", new AMControlStatusCheckerDefault(4), this);
	...
	imagingValves_->addControl(vvrImaging9_);
