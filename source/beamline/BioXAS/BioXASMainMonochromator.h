...
#define BRAGG_CRYSTAL_CHANGE_POSITION 66.0
#define BRAGG_REGION_A_DESTINATION -10.0
#define BRAGG_REGION_B_DESTINATION 330.0
#define CC_REGION_A_DESTINATION 15000.0
#define CC_REGION_B_DESTINATION -15000.0
