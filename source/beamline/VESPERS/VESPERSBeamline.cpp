...
void VESPERSBeamline::setupMono()
{
	...
	energyRelative_ = new AMPVwStatusControl("Relative Energy Movement", "07B2_Mono_SineB_deltaE:fbk", "07B2_Mono_SineB_delE", "SMTR1607-1-B20-20:status", "SMTR1607-1-B20-20:stop", this, 5, 2.0, new AMControlStatusCheckerDefault(1), 1);
	((AMPVwStatusControl *)energyRelative_)->setMoveStartTimeout(10.0);
	((AMPVwStatusControl *)energyRelative_)->setMoveStartTolerance(10.0);
