...
*/
  ...
  */
	...
	virtual QStringList enumNames() const { return QStringList(); }
	...
	virtual QString enumNameAt(double controlValue) { Q_UNUSED(controlValue) return QString(); }
	...
	virtual QStringList moveEnumNames() const { return QStringList(); }
