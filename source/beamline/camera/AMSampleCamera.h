...
public slots:
	...
	void setSamplePlate(AMShapeData* samplePlate);
        ...
        void createSamplePlate(QVector<QVector3D> coordinates, QVector<QPointF> points, int numberOfPoints);
		/// \todo make protected v
                QPair<QVector3D,QVector3D> findSamplePlateCoordinate(QVector3D originCoordinate, QVector3D shiftCoordinate, QPair<QPointF, QPointF> points);
