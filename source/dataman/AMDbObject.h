...
- You can use the AM_DBPROPERTYINFO macro to specify additional characteristics for each field, in the form of semicolon-separated 'key=value' pairs:
\code
AM_DBPROPERTYINFO(propertyName, "keyword1=value1;keyword2=value2;keyword3=value3...")
\endcode
	...
	If unspecified, the default value for all keywords is false.  Internally, this functionality is implemented using the Q_CLASSINFO system.

- You can use the AM_DBOBJECTINFO macro to specify characteristics for the entire object, also in the form of semicolon-separated 'key=value' pairs:
\code
AM_DBOBJECTINFO("keyword1=value1;keyword2=value2;...")
\endcode
...
public:
	...
	/// If this class has already been registered in the AMDbObject system, returns the AMDbObjectInfo describing this class's persistent properties.  If the class hasn't been registered, returns 0.
