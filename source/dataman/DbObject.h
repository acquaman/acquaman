...
public:
	...
	/// The type (aka class name) of this Scan (corresponding to the type of the most detailed subclass)
		/// This will be stored in the top table of the database and used to figure out the real type of Scan when loading
