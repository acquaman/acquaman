...
public:
	...
	/// Constructor. Takes a valid file ID and name of the HDF5 Group. Does not create the group itself.
	explicit AMHDF5Group(hid_t fileId, const QString &name, QObject *parent = 0);
...
protected:
	...
	hid_t id_;
	/// The file id this group is attached to.
	hid_t fileId_;
};
