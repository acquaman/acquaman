...
public:
	...
	/// Convenience constructor.  Uses a width to to auto-create a low and high value.
	AMROIInfo(const QString& name = "Invalid ROI Info", double energy = 0.0, double width = 0.0, double scale = 0.0, QObject *parent = 0);
