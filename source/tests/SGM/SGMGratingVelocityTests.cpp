...
//	// From 270ev (-412450) to 320eV (-348005)
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 0, 5000));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 0, 5000));

//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 1000, 5000));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 1000, 5000));

//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 3000, 5000));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 3000, 5000));

//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 0, 2500));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 0, 2500));

//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 1000, 2500));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 1000, 2500));

//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 3000, 2500));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 3000, 2500));

//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 0, 1000));
//	testQueue_.push_back(VelocityTestConditions(-412450, -397720, 61300, 12000, 0, 1000));
