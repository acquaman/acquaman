...
#include "tests/mocks/application/AMMockAppController.h"
...
int main(int argc, char *argv[])
{
	...
	app.setApplicationName("Mock Acquaman");


	AMMockAppController* appController = new AMMockAppController();
	...
	AMCrashMonitorSupport::s()->setPathToCrashReportFiles("/home/acquaman/AcquamanApplicationCrashReports/MockAM");
