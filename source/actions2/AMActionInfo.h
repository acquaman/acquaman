...
#ifndef AMACTIONINFO_H
#define AMACTIONINFO_H
...
*/
class AMActionInfo : public AMDbObject
{
	Q_OBJECT
...
public:
	...
	virtual AMActionInfo* createCopy() const { return new AMActionInfo(*this); }

	/// Destructor: nothing required in the base class
	virtual ~AMActionInfo() {}
