#ifndef STREALTIMEMODELAB_H
#define STREALTIMEMODELAB_H
...
public:
    /// Constructor.
    Q_INVOKABLE STRealtimeModelAB(const QString &outputName = "InvalidInput", QObject *parent = 0);
    /// Destructor.
