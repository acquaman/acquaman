...
public:
	...
	// NOTE FROM DARREN: If this gets commented back in, change it so that Q_INVOKABLE goes to the above constructor, like the following:
	Q_INVOKABLE StripToolAccumulatorAB(const QString &outputName = "InvalidInput", QObject *parent = 0);
