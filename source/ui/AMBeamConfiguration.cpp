...
AMBeamConfiguration::AMBeamConfiguration(QWidget *parent) :
    QWidget(parent)
{
...
void AMBeamConfiguration::beamChanged(QObject *newBeam)
{
    qDebug()<<"changing beam";
    AMBeamModel *beam = qobject_cast<AMBeamModel*>(newBeam);
    if(beam != 0)
    {
        beamModel_ = beam;
        updateData();
...
void AMBeamConfiguration::updateData()
{
...
void AMBeamConfiguration::updateOneOne(QVector3D one)
{
...
void AMBeamConfiguration::updateOneTwo(QVector3D two)
{
...
void AMBeamConfiguration::updateOneThree(QVector3D three)
{
...
void AMBeamConfiguration::updateOneFour(QVector3D four)
{
...
void AMBeamConfiguration::updateTwoOne(QVector3D one)
{
    QString x = QString::number(one.x());
    QString y = QString::number(one.y());
    QString z = QString::number(one.z());
...
void AMBeamConfiguration::updateTwoTwo(QVector3D two)
{
    QString x = QString::number(two.x());
    QString y = QString::number(two.y());
    QString z = QString::number(two.z());
...
void AMBeamConfiguration::updateTwoThree(QVector3D three)
{
    QString x = QString::number(three.x());
    QString y = QString::number(three.y());
    QString z = QString::number(three.z());
...
void AMBeamConfiguration::updateTwoFour(QVector3D four)
{
    QString x = QString::number(four.x());
    QString y = QString::number(four.y());
    QString z = QString::number(four.z());
