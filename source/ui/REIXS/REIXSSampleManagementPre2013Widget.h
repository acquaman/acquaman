...
#ifndef REIXSSAMPLEPOSITIONPRE2013VIEW_H
#define REIXSSAMPLEPOSITIONPRE2013VIEW_H
...
class REIXSSampleManagementPre2013Widget : public QWidget
{
Q_OBJECT
public:
...
\param sampleCameraUrl1 The url of the video feed to open. (You can add more video feeds later by accessing the cameraWidget() and calling addSource().)
...
\param manipulator [Optional] If you want the AMSamplePlateView to be able to mark and move sample positions, you should include an AMSampleManipulator instance \c manipulator, which will be passed to the AMSamplePlateView.*/
	REIXSSampleManagementPre2013Widget(QWidget *manipulatorWidget, const QUrl& sampleCameraUrl1, const QUrl& sampleCameraUrl2, AMSamplePlatePre2013* samplePlate = 0, AMSampleManipulator* manipulator = 0, QWidget *parent = 0);
	virtual ~REIXSSampleManagementPre2013Widget();

	/// Accesses the sample plate view
	AMSamplePlatePre2013View* samplePlateView() { return plateView_; }
#ifdef AM_MOBILITY_VIDEO_ENABLED
	/// Access the camera widget.
	AMBeamlineCameraWidget* cameraWidget() { return cameraWidget1_; }
	AMBeamlineCameraWidget* cameraWidget2() { return cameraWidget2_; }
#endif
...
#ifdef AM_MOBILITY_VIDEO_ENABLED
	AMBeamlineCameraWidget *cameraWidget1_;
	AMBeamlineCameraWidget *cameraWidget2_;
#endif
