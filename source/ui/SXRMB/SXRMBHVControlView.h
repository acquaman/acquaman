#ifndef SXRMBHVCONTROLVIEW_H
#define SXRMBHVCONTROLVIEW_H
...
class SXRMBHVControlView : public QWidget
{
    Q_OBJECT
public:
	/// the constructor to display a set of HV controls
	explicit SXRMBHVControlView(AMControlSet * hvControlSet, bool viewOnly = false, QWidget *parent = 0);
...
class SXRMBHVControlChannelView : public QWidget
{
	Q_OBJECT
public:
	/// Constructor for the HV Control Channel View
	explicit SXRMBHVControlChannelView(SXRMBHVControl * hvControlChannel, bool viewOnly = false, QWidget *parent = 0);
