...
MainWindow::MainWindow(QWidget* parent) : QWidget(parent) {
	...
	setCurrentScanConfigurationViewer(sxscViewer_);
...
void MainWindow::setCurrentScanConfigurationViewer(SGMXASScanConfigurationViewer *currentScanConfigurationViewer){
	currentScanConfigurationViewer_ = currentScanConfigurationViewer;
	connect(currentScanConfigurationViewer_, SIGNAL(scanControllerReady(AMScanController*)), this, SLOT(onScanControllerReady(AMScanController*)));
}
