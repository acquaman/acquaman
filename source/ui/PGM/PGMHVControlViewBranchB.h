#ifndef PGMHVCONTROLVIEWBRANCHB_H
#define PGMHVCONTROLVIEWBRANCHB_H
...
class PGMHVControlViewBranchB : public QWidget
{
    Q_OBJECT
public:
    /// Constructor.  Note, currently empty. Once PGMHVControl is complete it'll be
    /// passed into this.
    explicit PGMHVControlViewBranchB(QWidget *parent = 0);
...
#endif // PGMHVCONTROLVIEWBRANCHB_H
