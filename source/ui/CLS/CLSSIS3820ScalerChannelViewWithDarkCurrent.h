...
public slots:
    /// Updates all dark current UI elements.
    void updateDarkCurrentView();

protected slots:
    /// Updates the displayed dark current value.
    void updateDarkCurrentValue();
    /// Updates the status of the displayed dark current value.
    void updateDarkCurrentStatus();
    /// Updates the displayed corrected measurement.
