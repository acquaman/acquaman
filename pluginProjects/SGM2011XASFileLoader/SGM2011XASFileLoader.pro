...
# install
target.path = $$HOME_FOLDER/$$DEV_PATH/acquaman/pluginProjects/SGM2011XASFileLoader
sources.files = $$SOURCES $$HEADERS $$RESOURCES $$FORMS SGM2011XASFileLoader.pro
sources.path = $$HOME_FOLDER/$$DEV_PATH/acquaman/pluginProjects/SGM2011XASFileLoader
