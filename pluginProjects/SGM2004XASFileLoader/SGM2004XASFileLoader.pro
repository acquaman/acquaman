...
# install
target.path = $$HOME_FOLDER/$$DEV_PATH/acquaman/pluginProjects/SGM2004XASFileLoader
sources.files = $$SOURCES $$HEADERS $$RESOURCES $$FORMS SGM2004XASFileLoader.pro
sources.path = $$HOME_FOLDER/$$DEV_PATH/acquaman/pluginProjects/SGM2004XASFileLoader
